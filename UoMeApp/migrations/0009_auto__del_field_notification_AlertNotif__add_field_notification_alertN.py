...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.AlertNotif'
        db.delete_column(u'UoMeApp_notification', 'AlertNotif')

        # Adding field 'Notification.alertNotif'
        db.add_column(u'UoMeApp_notification', 'alertNotif',
