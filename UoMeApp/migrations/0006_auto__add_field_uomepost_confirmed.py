...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UoMePost.confirmed'
        db.add_column(u'UoMeApp_uomepost', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UoMePost.confirmed'
        db.delete_column(u'UoMeApp_uomepost', 'confirmed')
