...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UoMePost.ower_name'
        db.add_column(u'UoMeApp_uomepost', 'ower_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='ower', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UoMePost.ower_name'
        db.delete_column(u'UoMeApp_uomepost', 'ower_name_id')
