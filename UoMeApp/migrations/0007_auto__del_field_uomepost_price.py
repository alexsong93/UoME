...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UoMePost.price'
        db.delete_column(u'UoMeApp_uomepost', 'price')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UoMePost.price'
        raise RuntimeError("Cannot reverse this migration. 'UoMePost.price' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UoMePost.price'
        db.add_column(u'UoMeApp_uomepost', 'price',
                      self.gf('django.db.models.fields.IntegerField')(max_length=100),
                      keep_default=False)
