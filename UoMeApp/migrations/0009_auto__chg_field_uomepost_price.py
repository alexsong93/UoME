...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UoMePost.price'
        db.alter_column(u'UoMeApp_uomepost', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'UoMePost.price'
        db.alter_column(u'UoMeApp_uomepost', 'price', self.gf('django.db.models.fields.IntegerField')(max_length=100))
